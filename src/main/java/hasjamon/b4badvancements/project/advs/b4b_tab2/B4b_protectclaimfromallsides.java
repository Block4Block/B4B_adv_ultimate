...
public class B4b_protectclaimfromallsides extends BaseAdvancement  {
  ...
  public B4b_protectclaimfromallsides(Advancement parent) {
    super(KEY.getKey(), new AdvancementDisplay(Material.COMPASS, "(DISABLED)Cardinal Point Defense", AdvancementFrameType.TASK, true, true, 6f, 2f, "Protect a Claim Lectern from all \" + numProtectiveBlockFaces + \" directions."), parent, 1);
  }
}