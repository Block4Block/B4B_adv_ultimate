...
public class B4b_putmasterbookinenderchest extends BaseAdvancement  {
  ...
  public B4b_putmasterbookinenderchest(Advancement parent) {
    super(KEY.getKey(), new AdvancementDisplay(Material.ENDER_CHEST, "(DISABLED)Safekeeping", AdvancementFrameType.TASK, true, true, 8f, 8f, "Put an original Master Book in an Ender Chest."), parent, 1);
  }
}