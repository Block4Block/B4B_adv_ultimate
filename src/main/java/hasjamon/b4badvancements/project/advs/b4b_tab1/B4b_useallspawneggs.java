...
public class B4b_useallspawneggs extends BaseAdvancement  {
  ...
  public B4b_useallspawneggs(Advancement parent) {
    super(KEY.getKey(), new AdvancementDisplay(Material.CHICKEN_SPAWN_EGG, "(DISABLED)Egghead Eggtraordinaire", AdvancementFrameType.TASK, true, true, 7f, 14f, "Use each type of spawn egg at least once."), parent, 1);
  }
}